      ...
      <div className="bg-white shadow-md rounded-lg mb-2 tracking-wide hover:shadow-lg">
        <Link to="order">
          ...
          <div className="px-4 py-2 mt-1">
            <div className="mb-2">
              <h2 className="font-semibold text-base text-gray-800 tracking-normal line-clamp-3">ABC Pharmacy</h2>
            </div>
            <div className="author flex items-center my-2">
              <h2 className="text-sm tracking-tighter truncate text-gray-900">Subtitle</h2>
            </div>
          </div>
        </Link>
      </div>
