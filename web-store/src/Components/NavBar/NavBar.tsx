            ...
            <div>
              <Menu as="div" className="relative inline-block">
                ...
                <Menu.Items className="absolute z-20 mt-4 w-56 bg-white rounded-md shadow-lg transform -translate-x-full">
                  <Menu.Item as="div" className="flex flex-col p-4 font-medium border-b space-y-1">
                  ...
                  <Menu.Item as={Link} to="/" className="block px-4 py-2 hover:bg-gray-100 rounded-md transition">
                    Another Link
                  </Menu.Item>
                </Menu.Items>
              </Menu>
